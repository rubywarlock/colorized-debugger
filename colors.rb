module Colors
  ...
  COLORS = %i[black red green yellow blue magenta cyan white
    ...
    blueviolet brown burlywood cadetblue chartreuse chocolate coral cornflower 
    ...
    goldenrod gray greenyellow honeydew hotpink indianred indigo ivory khaki lavender 
    ...
    mediumvioletred midnightblue mintcream mistyrose moccasin navajowhite navyblue oldlace 
